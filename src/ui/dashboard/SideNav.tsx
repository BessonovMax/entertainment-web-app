...
export default function SideNav() {
  ...
  return (
    <div className="bg-card-background flex items-center justify-between p-4 md:p-5 lg:h-full lg:flex-col lg:justify-normal lg:rounded-[20px] lg:px-7 lg:py-[33.7px]">
